...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210608_elrelator_6819678af79458f54147_20210608050409_archive.zip';
	const ARCHIVE_SIZE		 = '24666775';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6819678-08050409';
    const SECONDARY_PACKAGE_HASH = '4d92ee6-08050409';
	const VERSION			 = '1.4.1';
