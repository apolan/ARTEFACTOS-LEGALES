...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210520_elrelator_ac74bff28237e5405818_20210520202933_archive.zip';
	const ARCHIVE_SIZE		 = '23546078';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ac74bff-20202933';
    const SECONDARY_PACKAGE_HASH = '2bd98ad-20202933';
	const VERSION			 = '1.4.0';
