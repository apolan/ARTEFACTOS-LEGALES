...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210611_elrelator_0359add550eb74129405_20210611182817_archive.zip';
	const ARCHIVE_SIZE		 = '26187416';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0359add-11182817';
    const SECONDARY_PACKAGE_HASH = 'b507813-11182817';
	const VERSION			 = '1.4.1';
