...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20201216_artefactos_b7714f6a8aae64377259_20201216183240_archive.zip';
	const ARCHIVE_SIZE		 = '19258348';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b7714f6-16183240';
    const SECONDARY_PACKAGE_HASH = '4723a9b-16183240';
